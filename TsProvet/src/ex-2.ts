// DIN UPPGIFT: Byt ut implicita any mot explicita typer 
// och ändra felaktiga värden så att koden kompilerar utan några Typescript-felmeddelanden / 2 poäng
...
while (true) {
	...
	let activity: string;
	let capacity: number;
	let requiresSupplies: boolean | undefined;
